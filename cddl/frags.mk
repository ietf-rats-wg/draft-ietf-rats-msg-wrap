...
CMW_CBOR_EXAMPLES += cmw-example-3.diag
CMW_CBOR_EXAMPLES += cmw-example-tag-1.diag
CMW_CBOR_EXAMPLES += cmw-example-tag-2.diag
CMW_CBOR_EXAMPLES += collection-example-1.diag
...
COLLECTED_CDDL_FRAGS := cmw-start.cddl
...
COLLECTED_CDDL_FRAGS += jws-cmw.cddl
...
SIGNED_JSON_CMW_CDDL_FRAGS += cmw-9277-json-tags.cddl
