...
In some scenarios, for instance, if CMW encapsulates Reference Values and/or Endorsements, a secure channel (e.g., via TLS {{?BCP195}}) or object-level security (e.g., using JWT {{?BCP225}}) may suffice, but this is not always the case.
