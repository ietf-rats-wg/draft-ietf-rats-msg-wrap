...
Before the creation of the registry by IANA, new codepoints can be added to a [provisional CMW Indicators registry](https://github.com/ietf-rats-wg/draft-ietf-rats-msg-wrap/blob/provisional-registry/provisional/cmw-indicators-registry.md) by following the documented procedure.
