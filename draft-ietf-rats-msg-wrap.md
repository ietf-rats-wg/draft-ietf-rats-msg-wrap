...
2. They are not a good match for modelling layered attestation given their top-down structure does not fit the bottom-up way in which the chain of trust is built in layered attestation.
